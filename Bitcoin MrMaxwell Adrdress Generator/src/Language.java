...
public class Language
{
	...
	public static String lblWürfelzeichenEingeben;	
...
{			
		...
		lblWürfelzeichenEingeben 	= "100 Würfelzeichen eingeben, es sind nur Ziffern zwischen 1 und 6 erlaubt !";
...
case 2:
{
		...
		lblWürfelzeichenEingeben 	= "100 caractères cubes, seuls les chiffres compris entre 1 et 6 sont autorisés !";
...
case 3:
{
		...
		lblWürfelzeichenEingeben 	= "100 символов, допускаются только номера от 1 до 6!";                        
...
case 4:
{
		...
		lblPassphrase 		 = "密码";																
		lblGebenSieEinen 	 = "输入密码";																
		lblWuerfelEingabe	 = "通过滚动骰子创建私钥";														
		lblWürfelzeichenEingeben = "100个字符，只允许1到6之间的数字！";               						          
		lblPrivateKeyIn		 = "输入私钥";																
		lblPrivateKeyIn_1	 = "比特币私钥";																
		lblPublicKeyX		 = "            公钥X";													
		lblPublicKeyY		 = "            公钥Y";													
		lblBase58		 = "基地58";																
		lblBitcoinAdress	 = "比特币地址";																
		btnStyle		 = "风格";
		btnInfo			 = "И信息";																
		btnDrucken		 = "打印";																
		btnSpeichern		 = "保存";																
		btnEnter		 = "输入";																
		btnPrivateKeyAusblenden	 = "隐藏私钥";																
		comboBoxPrivateKey[0]    = "十六进制";																
		comboBoxPrivateKey[1]    = "基地58";																
		comboBoxPrivateKey[2]    = "基座58压缩";															
		comboBoxPrivateKey[3]    = "基地64";																
		farbe			 = "颜色";																
		farbenAnpassen		 = "自定义颜色";																
